...
1. [**upstage-ambassador.jaeyeong2026.com**](https://upstage-ambassador.jaeyeong2026.com) 접속
...
| # | 스킬 | 설명 | 입력 → 출력 |
|---|------|------|-------------|
| 1 | `upstage-academic-mail` | ✉️ 한국어 학술 이메일 작성기 | bullet points → 완성된 이메일 (답장/맥락/CC 지원) |
| 2 | `upstage-paper-to-script` | 🎬 논문→발표 스크립트 생성기 | 논문 텍스트 → 타이밍 포함 스크립트 (2단계 요약/청중 맞춤) |
| 3 | `upstage-script-polisher` | 🎤 발표 스크립트 구어체 폴리싱 | 스크립트 → 자연스러운 발표 원고 (JSON 파이프라인/Before-After) |
...
# 5. 스크립트 폴리싱 (JSON 파이프라인)
python3 skills/upstage-script-polisher/scripts/run_script_polisher.py \
  --from-json "out/paper_script_*.script.json" --style conversational
```

### 스킬 다운로드

- **웹**: [Skills 페이지](https://upstage-ambassador.jaeyeong2026.com/skills.html)
...
├── docs/                    # GitHub Pages (upstage-ambassador.jaeyeong2026.com)
├── scripts/                 # CI 검증 스크립트
├── tests/                   # 테스트 fixture
...
- **워크플로우 다운로드**: [upstage-ambassador.jaeyeong2026.com](https://upstage-ambassador.jaeyeong2026.com)
- **스킬 다운로드**: [upstage-ambassador.jaeyeong2026.com/skills.html](https://upstage-ambassador.jaeyeong2026.com/skills.html)
